...
# chess intelligence; not done yet
...
#boardstate = json.loads(chess13.gui_sendboard(mainboard))
...
class ChessBoard(wx.Frame):
	def __init__(self, parent, title):
		self.engine = subprocess.Popen('/home/andrey/Dropbox/Python/chess14.py', stdout = subprocess.PIPE, stdin = subprocess.PIPE, bufsize=0, universal_newlines=True)
